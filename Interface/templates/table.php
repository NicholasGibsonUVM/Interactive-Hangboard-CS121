...
<script>document.getElementById("default").click();
</script>
<section class="tab">
	<?php
	...
	foreach ($sessionList as $sessionId) {
		...
		print '<button' . $default . ' class="tablinks" onclick="openSession(event, \'Session' . $sessionId['pmkSessionId'] . '\')"> Session ' . $counter . '</button>' . PHP_EOL;
		$counter++;
	}
	print '</div><div>';
